      ...
      <div className="w-11/12 mt-3 h-1/2 rounded-xl flex flex-row">
        <div className="relative w-4/5 h-full bg-red-100 rounded-l-xl overflow-hidden flex flex-col justify-between py-4 px-8">
          <img
            ...
            src="https://images.hdqwalls.com/wallpapers/japan-sunset-purple-evening-4k-5m.jpg"
            alt="sample"
          />
          ...
          <div className="relative z-10 text-white">
            ...
            <h1 className="text-lg w-4/5">
              The “Vancouver household bills between 2010-2019” dataset received
              2 new updates
            </h1>
            <button className="bg-blue-600 text-white py-4 px-8 font-extralight rounded-xl text-xs">
              View more detail
            </button>
          </div>
        </div>
        <div className="w-1/5 h-full bg-gray-600 rounded-r-xl flex flex-col items-center py-2 overflow-y-scroll">
          <h1 className="w-3/4 border-b border-white text-center">
            Hot Authors
          </h1>
          {[1, 2, 3, 4, 5].map((item) => (
            <div
              className="w-11/12 flex flex-row h-1/5 my-1 items-center"
              id={item}
            >
              <img
                className="h-12 w-12 object-cover rounded-full mx-3"
